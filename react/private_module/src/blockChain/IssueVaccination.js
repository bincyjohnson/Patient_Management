...
import { VACCINE_ABI } from './vaccineABI';

const IssueVaccination = async ({ address, web3, values }) => {
  const tokenAddress = '0x535Ac607e72146218Bc5e7d3b71a37944a77025C';

  const smartContract = await new web3.eth.Contract(VACCINE_ABI, tokenAddress);
...
export default IssueVaccination;
